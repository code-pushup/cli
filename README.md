...
| <ul><li>**[The CLI 📦 package](./packages/cli#readme)** helps to **collect** audits and **upload** reports.</li><li>**[Get started](./packages/cli/README.md#getting-started)** in no time! ⏱️</li></ul>                       | <ul><li>Use our **[🤖 GitHub Action](https://github.com/code-pushup/github-action)** seamless CI workflows.</li><li>The **[📦 core package](./packages/core#readme)** helps to craft your **custom tooling**.</li></ul> |
...
| <ul><li>**[Our portal](https://code-pushup.dev#portal)** 🌐 shows historical data in a slick UI</li><li>The **📦 [portal-client](https://www.npmjs.com/package/@code-pushup/portal-client)** helps to upload reports ⬆️</li></ul> | <ul><li>Use the 📦 **[models packag](./packages/models/README.md)** to get types and parsing in you plugins.</li><li>Find tons of useful helpers in the **[📦 utils package](./packages/utils/README.md)**</li></ul> |
