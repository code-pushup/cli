...
export function getConstantsFileContent(lhr: Result): string {
  ...
  return [
    '// !DO NOT EDIT!',
    `// This file is autogenerated form [lighthouse](https://github.com/GoogleChrome/lighthouse) version \`${lighthouseVersion}\``,
...
export async function getExampleReport(options?: {
  ...
  const outputPath = join('tmp', 'example-lighthouse-report-for-tooling-script.json');
