...
export const AUDITS = [
  ...
  {
    slug: 'ts-code-1166',
    title: 'Ts Code 1166-1166',
    description:
      "A computed property name in a class property declaration must have a simple literal type or a 'unique symbol' type.",
  },
  {
    slug: 'ts-code-1168',
    title: 'Ts Code 1168-1168',
    description:
  ...
  {
    slug: 'ts-code-1286',
    title: 'Ts Code 1286-1286',
    description:
      "ESM syntax is not allowed in a CommonJS module when 'verbatimModuleSyntax' is enabled.",
  },
  {
    slug: 'ts-code-1287',
    title: 'Ts Code 1287-1287',
    description:
  ...
  {
    slug: 'ts-code-2362',
    title: 'Ts Code 2362-2362',
    description:
      "The left-hand side of an arithmetic operation must be of type 'any', 'number', 'bigint' or an enum type.",
  },
  {
    slug: 'ts-code-2363',
    title: 'Ts Code 2363-2363',
    description:
      "The right-hand side of an arithmetic operation must be of type 'any', 'number', 'bigint' or an enum type.",
  },
  {
    slug: 'ts-code-2364',
    title: 'Ts Code 2364-2364',
    description:
      'The left-hand side of an assignment expression must be a variable or a property access.',
  },
  {
    slug: 'ts-code-2365',
    title: 'Ts Code 2365-2365',
  ...
  {
    slug: 'ts-code-2377',
    title: 'Ts Code 2377-2377',
    description:
      "Constructors for derived classes must contain a 'super' call.",
  },
  {
    slug: 'ts-code-2378',
    title: 'Ts Code 2378-2378',
    description: "A 'get' accessor must return a value.",
  },
  {
    slug: 'ts-code-2379',
    title: 'Ts Code 2379-2379',
    description:
  ...
  {
    slug: 'ts-code-2588',
    title: 'Ts Code 2588-2588',
    description: "Cannot assign to '{0}' because it is a constant.",
  },
  {
    slug: 'ts-code-2589',
    title: 'Ts Code 2589-2589',
    description:
      'Type instantiation is excessively deep and possibly infinite.',
  },
  {
    slug: 'ts-code-2590',
    title: 'Ts Code 2590-2590',
    description:
      'Expression produces a union type that is too complex to represent.',
  },
  {
    slug: 'ts-code-2591',
    title: 'Ts Code 2591-2591',
    description:
      "Cannot find name '{0}'. Do you need to install type definitions for node? Try `npm i --save-dev @types/node` and then add 'node' to the types field in your tsconfig.",
  },
  {
    slug: 'ts-code-2592',
    title: 'Ts Code 2592-2592',
    description:
