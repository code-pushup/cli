...
const auditSchema = z.object(
  {
    ...
    displayValue: z
      ...
      .optional(),
    value: z
      .number({description: 'Raw numeric value (defaults to score ?? details.warnings.length)',})
      .nonnegative()
      .min(0)
      .optional(),
    score: z
 ...
 *
 */
export function runnerOutputAuditRefsPresentInPluginConfigs(out: RunnerOutputSchema, cfg: PluginConfigSchema): true | string[] {
