...
export const lighthousePlugin: () => Required<PluginConfig> = () => ({
  ...
  audits: [
    ...
    },
    {
      ...
      label: 'Avoid multiple page redirects',
    },
    {
    ...
    },
    {
      ...
      label: 'Does not provide a valid `apple-touch-icon`',
    },
    {
      slug: 'splash-screen',
      ...
      label: 'Is not configured for a custom splash screen',
    },
    {
      slug: 'themed-omnibox',
      ...
      label: 'Does not set a theme color for the address bar.',
    },
    {
      slug: 'maskable-icon',
      ...
      label: "Manifest doesn't have a maskable icon",
    },
    {
      slug: 'content-width',
      ...
      label: 'Content is sized correctly for the viewport',
    },
    {
      ...
      label: 'Displays images with correct aspect ratio',
    },
    {
      ...
      label: 'Serves images with appropriate resolution',
    },
    {
      slug: 'preload-fonts',
      ...
      label: 'Fonts with `font-display: optional` are preloaded',
    },
    {
      slug: 'deprecations',
    ...
    },
    {
      ...
      label: 'Minimizes main-thread work',
    },
    {
      slug: 'bootup-time',
    ...
    },
    {
      ...
      label: 'All text remains visible during webfont loads',
    },
    {
      slug: 'diagnostics',
      title: 'Diagnostics',
    ...
    },
    {
      ...
      label: 'Network Round Trip Times',
    },
    {
      ...
      label: 'Server Backend Latencies',
    },
    {
    ...
    },
    {
      ...
      label: 'Keep request counts low and transfer sizes small',
    },
    {
      ...
      label: 'Minimize third-party usage',
    },
    {
      ...
      label: 'Lazy load third-party resources with facades',
    },
    {
    ...
    },
    {
      ...
      label: 'Largest Contentful Paint image was not lazily loaded',
    },
    {
      slug: 'layout-shift-elements',
      title: 'Avoid large layout shifts',
      description: 'These DOM elements contribute most to the CLS of the page.',
      label: 'Avoid large layout shifts',
    },
    {
      slug: 'long-tasks',
      ...
      label: 'Avoid long main-thread tasks',
    },
    {
      ...
      label: 'Avoids `unload` event listeners',
    },
    {
    ...
    },
    {
      ...
      label: 'Image elements have explicit `width` and `height`',
    },
    {
      ...
      label: 'Page has valid source maps',
    },
    {
      ...
      label: 'Preload Largest Contentful Paint image',
    },
    {
      slug: 'csp-xss',
      ...
      label: 'Ensure CSP is effective against XSS attacks',
    },
    {
    ...
    },
    {
      ...
      label: 'Site works cross-browser',
    },
    {
      ...
      label: "Page transitions don't feel like they block on the network",
    },
    {
    ...
    },
    {
      ...
      label: '`[accesskey]` values are unique',
    },
    {
      ...
      label: '`[aria-*]` attributes match their roles',
    },
    {
      ...
      label: '`button`, `link`, and `menuitem` elements have accessible names',
    },
    {
      ...
      label: '`[aria-hidden="true"]` is not present on the document `<body>`',
    },
    {
    ...
    },
    {
      ...
      label: 'ARIA input fields have accessible names',
    },
    {
      ...
      description:
        "When an element doesn't have an accessible name, screen readers announce it with a generic name, making it unusable for users who rely on screen readers. [Learn more](https://web.dev/aria-name/).",
      label: 'ARIA `meter` elements have accessible names',
    },
    {
      ...
      label: 'ARIA `progressbar` elements have accessible names',
    },
    {
      ...
      label: '`[role]`s have all required `[aria-*]` attributes',
    },
    {
    ...
    },
    {
      ...
      label: '`[role]`s are contained by their required parent element',
    },
    {
      slug: 'aria-roles',
    ...
    },
    {
      ...
      label: 'ARIA toggle fields have accessible names',
    },
    {
      ...
      description:
        "When an element doesn't have an accessible name, screen readers announce it with a generic name, making it unusable for users who rely on screen readers. [Learn more](https://web.dev/aria-name/).",
      label: 'ARIA `tooltip` elements have accessible names',
    },
    {
      ...
      description:
        "When an element doesn't have an accessible name, screen readers announce it with a generic name, making it unusable for users who rely on screen readers. [Learn more](https://web.dev/aria-name/).",
      label: 'ARIA `treeitem` elements have accessible names',
    },
    {
      ...
      label: '`[aria-*]` attributes have valid values',
    },
    {
      ...
      label: '`[aria-*]` attributes are valid and not misspelled',
    },
    {
      slug: 'button-name',
      ...
      label: 'Buttons have an accessible name',
    },
    {
      slug: 'bypass',
      ...
      label: 'The page contains a heading, skip link, or landmark region',
    },
    {
      slug: 'color-contrast',
      title:
    ...
    },
    {
      ...
      label: 'Definition list items are wrapped in `<dl>` elements',
    },
    {
      slug: 'document-title',
      ...
      label: 'Document has a `<title>` element',
    },
    {
      ...
      label: '`[id]` attributes on active, focusable elements are unique',
    },
    {
    ...
    },
    {
      ...
      label: 'No form fields have multiple labels',
    },
    {
      slug: 'frame-title',
      ...
      label: '`<frame>` or `<iframe>` elements have a title',
    },
    {
      slug: 'heading-order',
      ...
      label: 'Heading elements appear in a sequentially-descending order',
    },
    {
      slug: 'html-has-lang',
      ...
      label: '`<html>` element does not have a `[lang]` attribute',
    },
    {
      ...
      label: '`<html>` element has a valid value for its `[lang]` attribute',
    },
    {
      slug: 'image-alt',
      ...
      label: 'Image elements have `[alt]` attributes',
    },
    {
      ...
      label: '`<input type="image">` elements have `[alt]` text',
    },
    {
      slug: 'label',
    ...
    },
    {
      ...
      label: 'Links have a discernible name',
    },
    {
      slug: 'list',
      title:
    ...
    },
    {
      ...
      label: 'The document does not use `<meta http-equiv="refresh">`',
    },
    {
      slug: 'meta-viewport',
      title:
    ...
    },
    {
      ...
      label: '`<object>` elements have alternate text',
    },
    {
      slug: 'tabindex',
      ...
      label: 'No element has a `[tabindex]` value greater than 0',
    },
    {
    ...
    },
    {
      ...
      label: '`[lang]` attributes have a valid value',
    },
    {
      slug: 'video-caption',
      title:
    ...
    },
    {
      ...
      label: 'Custom controls have associated labels',
    },
    {
      ...
      label: 'Custom controls have ARIA roles',
    },
    {
      slug: 'focus-traps',
    ...
    },
    {
      ...
      label: 'The page has a logical tab order',
    },
    {
      slug: 'managed-focus',
    ...
    },
    {
      ...
      label: 'Uses efficient cache policy on static assets',
    },
    {
      ...
      label: 'Avoids enormous network payloads',
    },
    {
    ...
    },
    {
      ...
      label: 'Efficiently encode images',
    },
    {
    ...
    },
    {
      ...
      label: 'Use video formats for animated content',
    },
    {
      ...
      label: 'Remove duplicate modules in JavaScript bundles',
    },
    {
      ...
      label: 'Avoid serving legacy JavaScript to modern browsers',
    },
    {
      slug: 'doctype',
      ...
      label: 'Page has the HTML doctype',
    },
    {
      slug: 'charset',
      ...
      label: 'Properly defines charset',
    },
    {
      slug: 'dom-size',
      ...
      label: 'Avoids an excessive DOM size',
    },
    {
      ...
      label: 'Avoids requesting the geolocation permission on page load',
    },
    {
      ...
      label: 'No issues in the `Issues` panel in Chrome Devtools',
    },
    {
    ...
    },
    {
      ...
      label: 'Avoids requesting the notification permission on page load',
    },
    {
      ...
      label: 'Allows users to paste into password fields',
    },
    {
      slug: 'uses-http2',
      title: 'Use HTTP/2',
    ...
    },
    {
      ...
      label: 'Uses passive listeners to improve scrolling performance',
    },
    {
      ...
      label: 'Document does not have a meta description',
    },
    {
      ...
      label: 'Page has successful HTTP status code',
    },
    {
      slug: 'font-size',
      ...
      label: 'Document uses legible font sizes',
    },
    {
      slug: 'link-text',
    ...
    },
    {
      ...
      label: 'Page isn’t blocked from indexing',
    },
    {
      slug: 'robots-txt',
    ...
    },
    {
      ...
      label: 'Tap targets are sized appropriately',
    },
    {
      slug: 'hreflang',
      ...
      label: 'Document has a valid `hreflang`',
    },
    {
      slug: 'plugins',
    ...
    },
    {
      ...
      label: 'Document has a valid `rel=canonical`',
    },
    {
      ...
      label: 'Structured data is valid',
    },
  ],
});
