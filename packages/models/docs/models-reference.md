...
| `docsUrl`                | Documentation site                   | [Url](#url) (_optional_) _or_ `''`                                                                                                                                                                                                                                                                    |
...
| **`plugin`** (\*)        | Plugin which defines it              | _Object with properties:_<ul><li>**`slug`** (\*): [Slug](#slug) - Unique plugin slug within core config</li><li>**`title`** (\*): `string` (_max length: 256_) - Descriptive name</li><li>`docsUrl`: [Url](#url) (_optional_) _or_ `''` - Plugin documentation site</li></ul>                         |
...
| `docsUrl`        | Link to documentation (rationale)        | [Url](#url) (_optional_) _or_ `''` |
...
| `docsUrl`        | Category docs URL                            | [Url](#url) (_optional_) _or_ `''`                      |
| `isSkipped`      |                                              | `boolean`                                               |
| `scoreTarget`    | Pass/fail score threshold (0-1)              | `number` (_≥0, ≤1_)                                     |
...
| `docsUrl`        | Group documentation site                     | [Url](#url) (_optional_) _or_ `''`                |
...
| **`title`** (\*)  | Descriptive name                                                                                                 | `string` (_max length: 256_)                                         |
| `description`     | Description (markdown)                                                                                           | `string` (_max length: 65536_)                                       |
| `docsUrl`         | Plugin documentation site                                                                                        | [Url](#url) (_optional_) _or_ `''`                                   |
| `isSkipped`       |                                                                                                                  | `boolean`                                                            |
...
| `portalUrl`            | Link to comparison page in Code PushUp portal   | [Url](#url)                                                                                                                                                                                                                                                                                                                                                |
| `label`                | Label (e.g. project name)                       | `string`                                                                                                                                                                                                                                                                                                                                                   |
...
| Property                | Description                                                          | Type                 |
| :---------------------- | :------------------------------------------------------------------- | :------------------- |
| **`server`** (\*)       | URL of deployed portal API                                           | [Url](#url)          |
